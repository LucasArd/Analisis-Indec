...
El procesamiento fue realizado en Python mediante pandas, numpy, matplotlib, seaborn y scikit-learn. La eleccion del lenguaje no modifica la metodologia estadistica aplicada: las operaciones realizadas equivalen a procedimientos habituales de R, como agrupar y resumir datos, unir tablas, construir graficos y estimar modelos de regresion. Por ejemplo, los agrupamientos de pandas cumplen el mismo rol que group_by/summarise en dplyr, los cruces de tablas equivalen a joins y los graficos generados con seaborn/matplotlib cumplen una funcion similar a los realizados con ggplot2.
